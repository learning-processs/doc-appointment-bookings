...
const DoctorDashboard = () => {
  ...
  const {dToken,backendUrl,  dashData, setDashData,getDashData } = useContext(DoctorContext);
  ...
  return dashData && (
    ...
    <div className="pt-4 border border-t-0 ">
      {(dashData.latestAppointments || []).map((item, index) => (
        <div key={index} className="flex items-center py-3 px-6 hover:bg-gray-100">
          <img src={item.userData.image} className="rounded-full w-10" alt="" />
