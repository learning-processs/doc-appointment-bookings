      ...
      <div className="bg-white px-8 py-8 border rounded w-full max-h-[80vh] overflow-y-scroll">
        <div className="flex items-center gap-4 mb-8 text-gray-500">
            <label htmlFor="doc-img">
                <img src={ docImg ? URL.createObjectURL(docImg) :assets.upload_area} className='w-16 bg-green-100 rounded-full cursor-pointer' alt="" />
            </label>
        ...
        <div className="flex flex-col lg:flex-row items-start gap-10 text-gray-600">
            <div className="w-full lg:flex-1 flex flex-col gap-4">
                ...
                <div className="flex-1 flex flex-col gap-1">
                    ...
                    <select name="" onChange={(e)=>setExperience(e.target.value)} value={experience} id="" className='border rounded px-3 py-2'>
